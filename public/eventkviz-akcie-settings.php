...
class Eventkviz_henkel_Class extends Eventkviz_Akcia_Class {
    public function __construct() {
        // Constructor code here
    }
    ...
    public function all_quizes_settings(){
       // global $all_quizes_settings;
        ...
        $this->all_quizes_settings['identifikacia_kodom_usera'] = true;//moznost identifikovat uzivatela kodom
        $this->all_quizes_settings['verify_users_in_db'] = false;//moznost verifikovat uzovatela v predvyplnenej databaze
        $this->all_quizes_settings['identifikacia_userov_timu'] = false;//moznost identifikovania viacerych uzivatelov v ramci jedneho timu . FALSE-ak je zoznam userov s priradenymi timami, tim sa vyberie automaticky.
        $this->all_quizes_settings['select_from_teams_array'] = false; // ma sa team vybrat z vopred zadaneho zoznamu, zoznam nizsie.
        $this->all_quizes_settings['select_teams'] = array(
            '' => 'Select ...',
            'team1' => 'Team 1',
            'team2' => 'Team 2',
    ...
    public function music_quiz_settings(){
       // global $music_settings;
        ...
        $this->music_settings['zobraz_spravne_odpovede'] = true;  //moznost vybrat ci sa uzivatelovi zobrazia spravne odpovede po odoslani kvizu, alebo nezobrazia
        $this->music_settings['pocet_pokusov'] = 1000;  //moznost rozhodnut sa ci moze uzivatel absolvovat kviz len raz, alebo viac krat (da sa urcit pocet kolko krat) 
    ...
    public function movies_quiz_settings(){
        ...
        $this->movies_settings['zobraz_spravne_odpovede'] = true;  //moznost vybrat ci sa uzivatelovi zobrazia spravne odpovede po odoslani kvizu, alebo nezobrazia
        $this->movies_settings['pocet_pokusov'] = 1000;  //moznost rozhodnut sa ci moze uzivatel absolvovat kviz len raz, alebo viac krat (da sa urcit pocet kolko krat) 
    ...
    public function knowledge_quiz_settings(){
        ...
        $this->knowledge_settings['knowledge_quiz_active'] = false;
        $this->knowledge_settings['credits'] = array (
            'corr_answer' => 30
        );
        ...
        $this->knowledge_settings['zobraz_spravne_odpovede'] = true;  //moznost vybrat ci sa uzivatelovi zobrazia spravne odpovede po odoslani kvizu, alebo nezobrazia
        $this->knowledge_settings['pocet_pokusov'] = 1000;  //moznost rozhodnut sa ci moze uzivatel absolvovat kviz len raz, alebo viac krat (da sa urcit pocet kolko krat) 
